...
pod repo update Specs && pod repo push Specs __ProjectName__.podspec --verbose --allow-warnings --use-libraries --sources='git@git.silvrr.com:iOS/Specs.git,https://github.com/CocoaPods/Specs'
